    ...
    <div className="container mt-5 p-5">
        <div className="row d-none d-sm-block d-lg-none d-md-none">
         <div className="col-md-12 ms-5">
            <button className='btn btn-sm btn-dark position-fixed top-25' data-bs-toggle="offcanvas" data-bs-target="#courseMenu">
        ...
        <div className="row">
          ...
          <div className="col-md-12">
              <div className='sidebar border border-right col-md-3 col-lg-2 p-0 bg-body-tertiary sticky-md-top'>
