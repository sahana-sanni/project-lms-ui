  ...
  return (
    <div className='container pt-5'>
      ...
      <div className="row mb-5 p-5">
        <div className="col-md-6 col-sm-12 col-lg-6">
          <div className="card">
            <div className="card-body">
              <p className="text-theme">For Technical queries, Please post your questions on our <NavLink to={`/forum`}>Forum</NavLink>, where you can get help from our alumini team.</p>
        ...
        <img src={`${process.env.PUBLIC_URL}/images/contact_us.svg`} alt='' className='img-fluid'/>
        </div>
      </div>
    </div>
  )
